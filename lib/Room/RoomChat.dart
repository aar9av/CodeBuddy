...
class RoomChat extends StatefulWidget {
  ...
  const RoomChat({super.key, required this.index, required this.isCreated});
...
class _RoomChatState extends State<RoomChat> {
  ...
  Widget build(BuildContext context) {
    dynamic roomData = widget.isCreated ? Data.createdRooms[widget.index] : Data.userRooms[widget.index];
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextButton(
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => RoomDescription(index: widget.index, isCreated: widget.isCreated),));
          },
          child: Text(
            roomData['name'],
            style: TextStyle(
